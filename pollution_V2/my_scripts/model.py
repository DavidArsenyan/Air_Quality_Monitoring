...
# -----------------------------
# 5. Build and Train LSTM model (ALWAYS TRAIN) 🚀
# -----------------------------
...
# Training
# NOTE: This part runs every time the script is executed.
history = model.fit(
    X_train,
    y_train,
    epochs=50,
    batch_size=16,
    verbose=0  # Set to 0 to suppress lengthy output during daily run
)
